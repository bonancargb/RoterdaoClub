...
$(document).ready(function() {
    // Select the button with the class 'mais'
    ...
    $button.click(function() {
        /*alert("clique");*/
        // Calculate the total number of 'div' elements with class 'row-hidden'
        var totalDivs = $('.row-hidden').length; 
        // Check if there are any 'div' elements with class 'row-hidden' that do not have 'hide'
        var $divsWithHide = $('.row-hidden.hide'); 
    /*console.log("total" + totalDivs);
    console.log("hide" + $divsWithHide.length);*/
        // If such divs exist and the current index is less than the total number of divs
        if ($divsWithHide.length > 1 && currentIndex <= totalDivs) {
            // Remove 'hide' to the div at the current index
            ...
            // If all 'div' elements with class 'row-hidden' no longer have 'hide', reset the index to 0
            currentIndex = 0;
